...
int CDECL_CALL main(int argc, char** argv, char** envArg)
{
	...
	unique_ptr<HumanSensor> sensor = unique_ptr<HumanSensor>(new HumanSensor(&SensorBus::SendSignal, new SensorBus()));
